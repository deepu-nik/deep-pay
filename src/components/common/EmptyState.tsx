...
export function EmptyState({ icon = "receipt-outline", title, message }: { icon?: keyof typeof Ionicons.glyphMap; title: string; message: string }) {
  ...
  const styles = StyleSheet.create({
    ...
    icon: { width: 52, height: 52, borderRadius: 26, backgroundColor: colors.surfaceMuted, alignItems: "center", justifyContent: "center", marginBottom: spacing.sm },
    message: { color: colors.textMuted, textAlign: "center", maxWidth: 280 },
  });
