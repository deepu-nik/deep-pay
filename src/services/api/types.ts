...
export interface GroupService { listGroups(): Promise<Group[]>; createGroup(input: CreateGroupInput): Promise<Group>; updateGroup(id: string, input: CreateGroupInput): Promise<Group>; deleteGroup(id: string): Promise<void>; }
